...
global.owner = ['94743579817'] 
//👇 Your Caption ( Image Video )
global.cap = '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 Ⓒⓨⓑⓔⓡⓣⓡⓞⓝ ²⁰²³'
//👇 Your Bot Name
global.botnma =  'Ⓒⓨⓑⓔⓡⓣⓡⓞⓝ 𝚳𝐃 3 𝛁' 
//👇 Your name
global.ownernma =  '𝕄𝕔
...
//👇 Owner React Imoji
global.OWNER_REACT =  '💻🙂🙂🥺🥹💪😆😁🤞😉✌️🤷‍♂️🤷‍♀️🤦‍♀️🤦‍♂️🙌🤣😍😒👌😘👍Various smiley faces and people related emojis

😀😃😄😁😆😅🤣😂🙂🙃😇😉😊☺😋😌🥰😍🤩😘😗😙🥲😚😜🤪😝🤑🤭🤫🤔🤐🤨🤗😛😎🤓🧐😏😶😐😑😒🙄😬🤥😳🥺😞😟😠🤬😡😔😕🙁☹😣😖😫🥱😩😤😮😱😨😰😯😦😧😢😥😪🤤😓😭😵😲😷🤒🤕🤢🤮🤧🥵🥶🥴😵🤯🤠🥳🥸😴💤💩🤡😈👿👹👺💀👻👽👾🤖😺😸😹😻😼😽🙀😿😾🙌👏👋🤛🤜🤚👍👎👊✊✌🤞🤟🤘🤙👌🤌🤏✋👐💪🦾🦿🦵🦶🤲🤝🙏☝👆👇👈👉🖕🖐🖖✍💅🤳👄👅👂🦻👃🧠🫀🫁🦷🦴👁👀👤👥🗣👶🧒👦👧🧑👨🧔👩🧓👱👴👵👲👳👮👷💂🥷🕵🎅👼🤶🦸🦹🧙🧚🧛🧜🧝🧞🧟🤴👸🧕🤵🤰🤱👰🚶🧍🧎🏃💃👯🧖🧗👫👬👭🙇🤦🤷💁🙅🙆🙋🧏🙎🙍💇💆💑💏👪👚👕👖👔👗👙👘💄💋👣🦰🦱🦲🦳👠👡👢👞👟🥾🥿👒🎩⛑🎓🧢🪖👑🎒👝👛👜💼👓🕶🥽🥼🦺🧣🧤🧥🧦🥻🩰🩱🩲🩳💍🌂
🐶🐱🐭🐹🐰🐻🐼🦥🦦🦨🦩🦚🦜🦤🪶🪲🦘🦡🦢🦉🐯🐮🐷🐽🐸🐙🐵🙈🙉🙊🐒🦍🦧🐔🦮🐧🐦🐤🐣🐥🐺🦊🦝🦁🐗🐴🐝🐛🐌🦋🐞🦗🪳🐜🕷🐍🐢🦎🐠🐟🐡🦈🐬🦭🐳🐋🐊🐆🐅🐃🐂🐄🐪🐫🦙🦒🐘🦣🦏🦛🐐🐏🐑🐎🦄🦓🦌🦬🐖🐀🐁🐓🕊🐕🐩🐈🐇🐿🦫🦔🦇🐾🦃🦅🦆🐉🦕🦖🐲🌵🎄🌲🌳🌴🌱🪴🌿☘🍀🎍🎋🍃🍂🍁🌾🌺🌻🌹🥀🌷🌼🌸💐🍄🌰🎃🐚🕸🦂🦟🪰🪱🦠🌎🌍🌏🌕🌖🌗🌘🌑🌒🌓🌔🌚🌝🌛🌜🌞🌙⭐🌟💫✨☄☀🌤⛅🌥🌦☁🌧⛈🌩⚡🔥💥❄🌨☃⛄🌬💨🌪🌫☂☔💧💦💦💨🪨🪵
🍏🍎🍐🍊🍋🍌🍉🍇🍓🫐🥝🫒🥥🥑🍈🍒🍑🍍🥭🍅🍆🥦🥔🧄🧅🥜🥒🥬🥕🫑🌶🌽🍠🍯🍞🥐🥖🫓🥨🥯🥞🧇🧀🍗🥩🥓🍖🍤🍳🥘🍔🍟🌭🥪🍕🍝🌮🌯🫔🥙🧆🥚🍜🍲🫕🥣🥗🍥🍣🍱🍛🍙🍚🍘🍢🍡🥟🥠🥡🦀🦞🦐🦑🦪🍧🍨🍦🍰🧁🥧🎂🍮🍬🍭🍫🍿🧈🧂🥫🍩🍪🍺🍻🥂🥃🥤🧋🧃🧉🧊🥢🍷🍸🍹🍾🍶🍵☕🍼🥛🫖🍴🍽🥄
Sports & Activity Emoji
Various activities & sports related emojis'
//👇 Song Download Massage 
global.SONG_DOWN = '```⬇️𝕕𝕠𝕨𝕟𝕝𝕠𝕒𝕕𝕚𝕟𝕘 𝕪𝕠𝕦𝕣 𝕤𝕠𝕟𝕘
...```' 
//👇 Song Uplode massage 
global.SONG_UP = '```⬆️𝕦𝕡𝕝𝕠𝕒𝕕𝕚𝕟𝕘 𝕪𝕠𝕦𝕣 𝕤𝕠𝕟𝕘
ur Song...```'
//👇 Menu imoji 
...
//👇 Removebg Api key
global.REMOVE_BG_API = 'mmKZYC23QAXtH6Nphs5VXz4j'
//👇 Change Bot Language 
global.LANG = 'EN'
//Alive logo
global.alivelogo = process.env.ALIVE_IMAGE || `https://ibb.co/Jn5s5Mh`
//👇 Alive message
global.ALIVE_MESSAGE = process.env.ALIVE_MESSAGE || `default`
//👇 Welcome Mesaage
global.WELCOME = process.env.WELCOME || ``
//👇 welcome image 
global.WELCOME_IMAGE = process.env.WELCOME_IMAGE || `https://ibb.co/k5TMmVc`
//👇 Goodbye message 
global.GOODBYE = process.env.GOODBYE || ``
//👇 Good bye image
global.GOODBYE_IMAGE = process.env.GOODBYE_IMAGE || `https://ibb.co/QCTwJtg`
//👇 DISABLE PM Block numbers
global.NO_BLOCK = ["94715166712","94719574492"]
//👇 DISABLE download words
global.IMG_BLOCKER = ["xxx","sex","mia"]
//👇 Open ai API Put Withouth "sk-" ( "sk-" අයින් කරල ඉතුරු ටික දාන්න )
global.CHATGPT_API = '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'
...
//other
global.pemilik = ['94743579817'] //Change  it , ඔබට කැමති නම් වෙනස් කරන්න
global.premium = ['94743579817'] //Change it ඔබට කැමතිනම් වෙනස් කරන්න 
global.pengguna = 'mc' // Your name ඔබේ නම 
